...
# allowing densify but not pruning
# python train.py -s /NAS/samp8/datasets/nerf_synthetic_colmap/lego/  --random_pcd_path /NAS/samp8/datasets/nerf_synthetic_colmap/lego/random_30000_points3d.txt --model_path output/lego_around_30K_pcd_from_SFM_no_prune_with_densification --eval --white_background --width_load 800 --height_load 800 --pcd_size 30000 --max_densify 0.1 --use_pruning 0
...
# allowing densify but not pruning
# python train.py -s /NAS/samp8/datasets/nerf_synthetic_colmap/chair/  --random_pcd_path /NAS/samp8/datasets/nerf_synthetic_colmap/chair/random_30000_points3d.txt --model_path output/chair_around_30K_pcd_from_SFM_no_prune_with_densification --eval --white_background --width_load 800 --height_load 800 --pcd_size 30000 --max_densify 0.1 --use_pruning 0
# echo "chair done --------------------------------------------------------------------------------------------"
...
# allowing densify but not pruning
# python train.py -s /NAS/samp8/datasets/nerf_synthetic_colmap/drums/  --random_pcd_path /NAS/samp8/datasets/nerf_synthetic_colmap/drums/random_30000_points3d.txt --model_path output/drums_around_30K_pcd_from_SFM_no_prune_with_densification --eval --white_background --width_load 800 --height_load 800 --pcd_size 30000 --max_densify 0.1 --use_pruning 0
# echo "drums done --------------------------------------------------------------------------------------------"
...
python train.py -s /NAS/samp8/datasets/nerf_synthetic_colmap/ficus/  --random_pcd_path /NAS/samp8/datasets/nerf_synthetic_colmap/ficus/random_30000_points3d.txt --model_path output/ficus_around_30K_pcd_from_SFM_no_prune_with_densification --eval --white_background --width_load 800 --height_load 800 --pcd_size 30000 --max_densify 0.1 --use_pruning 0
echo "ficus done --------------------------------------------------------------------------------------------"
...
python train.py -s /NAS/samp8/datasets/nerf_synthetic_colmap/hotdog/  --random_pcd_path /NAS/samp8/datasets/nerf_synthetic_colmap/hotdog/random_30000_points3d.txt --model_path output/hotdog_around_30K_pcd_from_SFM_no_prune_with_densification --eval --white_background --width_load 800 --height_load 800 --pcd_size 30000 --max_densify 0.1 --use_pruning 0
echo "hotdog done --------------------------------------------------------------------------------------------"
...
# allowing densify but not pruning
# python train.py -s /NAS/samp8/datasets/nerf_synthetic_colmap/materials/  --random_pcd_path /NAS/samp8/datasets/nerf_synthetic_colmap/materials/random_30000_points3d.txt --model_path output/materials_around_30K_pcd_from_SFM_no_prune_with_densification --eval --white_background --width_load 800 --height_load 800 --pcd_size 30000 --max_densify 0.1 --use_pruning 0
# echo "materials done --------------------------------------------------------------------------------------------"
...
# allowing densify but not pruning
# python train.py -s /NAS/samp8/datasets/nerf_synthetic_colmap/ship/  --random_pcd_path /NAS/samp8/datasets/nerf_synthetic_colmap/ship/random_30000_points3d.txt --model_path output/ship_around_30K_pcd_from_SFM_no_prune_with_densification --eval --white_background --width_load 800 --height_load 800 --pcd_size 30000 --max_densify 0.1 --use_pruning 0
# echo "ship done --------------------------------------------------------------------------------------------"
...
# allowing densify but not pruning
# python train.py -s /NAS/samp8/datasets/nerf_synthetic_colmap/mic/  --random_pcd_path /NAS/samp8/datasets/nerf_synthetic_colmap/mic/random_30000_points3d.txt --model_path output/mic_around_30K_pcd_from_SFM_no_prune_with_densification --eval --white_background --width_load 800 --height_load 800 --pcd_size 30000 --max_densify 0.1 --use_pruning 0
# echo "mic done --------------------------------------------------------------------------------------------"
...
# allowing densify but not pruning
# python train.py -s /NAS/samp8/datasets/TanksAndTemple_colmap/Family/  --random_pcd_path /NAS/samp8/datasets/TanksAndTemple_colmap/Family/random_30000_points3d.txt --model_path output/Family_around_30K_pcd_from_SFM_no_prune_with_densification --eval --white_background --pcd_size 30000 --max_densify 0.1 --use_pruning 0
# echo "Family done --------------------------------------------------------------------------------------------"
...
# allowing densify but not pruning
# python train.py -s /NAS/samp8/datasets/TanksAndTemple_colmap/Barn/  --random_pcd_path /NAS/samp8/datasets/TanksAndTemple_colmap/Barn/random_30000_points3d.txt --model_path output/Barn_around_30K_pcd_from_SFM_no_prune_with_densification --eval --white_background --pcd_size 30000 --max_densify 0.1 --use_pruning 0
# echo "Barn done --------------------------------------------------------------------------------------------"
...
# allowing densify but not pruning
# python train.py -s /NAS/samp8/datasets/TanksAndTemple_colmap/Caterpillar/  --random_pcd_path /NAS/samp8/datasets/TanksAndTemple_colmap/Caterpillar/random_30000_points3d.txt --model_path output/Caterpillar_around_30K_pcd_from_SFM_no_prune_with_densification --eval --white_background --pcd_size 30000 --max_densify 0.1 --use_pruning 0
...
python train.py -s /NAS/samp8/datasets/TanksAndTemple_colmap/Ignatius/  --random_pcd_path /NAS/samp8/datasets/TanksAndTemple_colmap/Ignatius/random_30000_points3d.txt --model_path output/Ignatius_around_30K_pcd_from_SFM_no_prune_with_densification --eval --white_background --pcd_size 30000 --max_densify 0.1 --use_pruning 0
echo "Ignatius done --------------------------------------------------------------------------------------------"
...
# allowing densify but not pruning
# python train.py -s /NAS/samp8/datasets/TanksAndTemple_colmap/Truck/  --random_pcd_path /NAS/samp8/datasets/TanksAndTemple_colmap/Truck/random_30000_points3d.txt --model_path output/Truck_around_30K_pcd_from_SFM_no_prune_with_densification --eval --white_background --pcd_size 30000 --max_densify 0.1 --use_pruning 0
# echo "Truck done --------------------------------------------------------------------------------------------"
